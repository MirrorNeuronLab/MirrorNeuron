...
MN_DIST_PORT=4371 bash scripts/start_cluster_node.sh --box1-ip $BOX1_IP --box2-ip $BOX2_IP --box 1 &
NODE1_PID=$!

sleep 5

echo "Starting node 2 (Leader Candidate 2)"
MN_DIST_PORT=4372 bash scripts/start_cluster_node.sh --box1-ip $BOX1_IP --box2-ip $BOX2_IP --box 2 &
NODE2_PID=$!
