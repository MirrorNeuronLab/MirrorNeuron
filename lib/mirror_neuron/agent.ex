defmodule MirrorNeuron.Agent do
  ...
  Runtime loss starts a clean job attempt from the manifest and its declared
  inputs. Agent process state is not a recovery contract.
  """
  @type action ::
          {:emit, String.t(), map()}
  ...
  @optional_callbacks inspect_state: 1
